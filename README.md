...
| **crates.io** | [peasy-pdf](https://crates.io/crates/peasy-pdf) | `cargo add peasy-pdf` |
...
|---------|------|-----|----------|-----------|-------------|
| **peasy-pdf** | [PyPI](https://pypi.org/project/peasy-pdf/) | [npm](https://www.npmjs.com/package/peasy-pdf) | **[Gem](https://rubygems.org/gems/peasy-pdf)** | [Crate](https://crates.io/crates/peasy-pdf) | **PDF manipulation — merge, split, compress, rotate, watermark** |
